...
def beamsearch(start, end, beamsize=3):
    ...
    while len(open_set) > 0:
        ...
        draw(open_set, closed_set, open_set[:beamsize])
        for item in open_set[:beamsize][:]:
...
def draw(open_set, closed_set, os):
